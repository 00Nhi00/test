<?php
  ...
  $ruble_converted = $ruble_rate * $ruble;
  $pound_converted = $pound_rate * $pound;
  $canadian_converted = $canadian_rate * $canadian;
  $euro_converted = $euro_rate * $euro;
  $yen_converted = $yen_rate * $yen;
...
<head>
  ...
  <title>My Currency Exercise</title>
